...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"utils/invariant.ts":[function(require,module,exports) {
"use strict";
...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"ui/App.tsx":[function(require,module,exports) {
"use strict";
...
exports.App = function () {
  return react_1.default.createElement("div", null, react_1.default.createElement("div", null, "Hello"));
};
},{"tslib":"../node_modules/tslib/tslib.es6.js","react":"../node_modules/react/index.js"}],"ui/index.tsx":[function(require,module,exports) {
"use strict";
...
function mountUI(store, rootElement) {
  function renderApp() {
    react_dom_1.render(react_1.default.createElement(App_1.App, {
...
},{"tslib":"../node_modules/tslib/tslib.es6.js","react-dom":"../node_modules/react-dom/index.js","./App":"ui/App.tsx","react":"../node_modules/react/index.js"}],"store/index.ts":[function(require,module,exports) {
"use strict";
...
},{"hey-listen":"../node_modules/hey-listen/dist/hey-listen.es.js","process":"../node_modules/process/browser.js"}],"canvas/core/types.ts":[function(require,module,exports) {
"use strict";
...
(function (ElementType) {
  ElementType["Operation"] = "Operation";
  ElementType["Element"] = "Element";
})(ElementType = exports.ElementType || (exports.ElementType = {}));

function isOperation(elem) {
  return !!elem && elem[exports.$$TYPE] === ElementType.Operation;
}

exports.isOperation = isOperation;

function isElement(elem) {
  return !!elem && elem[exports.$$TYPE] === ElementType.Element;
}

exports.isElement = isElement;

function flattenElements(n) {
...
},{}],"canvas/core/OperationFactory.ts":[function(require,module,exports) {
"use strict";
...
function createOperationFactory() {
  var factory = {};
  var methods = ['restore', 'save', 'resetTransform', 'rotate', 'scale', 'setTransform', 'setTransform', 'transform', 'translate', 'clearRect', 'fillRect', 'strokeRect', 'beginPath', 'clip', 'clip', 'fill', 'fill', 'stroke', 'stroke', 'arc', 'arcTo', 'bezierCurveTo', 'closePath', 'ellipse', 'lineTo', 'moveTo', 'quadraticCurveTo', 'rect'];
  methods.forEach(function (name) {
    factory[name] = function () {
      ...
      return _ref = {}, _defineProperty(_ref, types_1.$$TYPE, types_1.ElementType.Operation), _defineProperty(_ref, "type", name), _defineProperty(_ref, "args", args), _defineProperty(_ref, "property", false), _ref;
    };
  });
  var properties = ['fillStyle', 'strokeStyle', 'lineCap', 'lineDashOffset', 'lineJoin', 'lineWidth'];
  properties.forEach(function (name) {
    factory[name] = function () {
      ...
      return _ref2 = {}, _defineProperty(_ref2, types_1.$$TYPE, types_1.ElementType.Operation), _defineProperty(_ref2, "type", name), _defineProperty(_ref2, "args", args), _defineProperty(_ref2, "property", true), _ref2;
    };
  });
  return factory;
}
...
},{"./types":"canvas/core/types.ts"}],"canvas/core/index.ts":[function(require,module,exports) {
"use strict";
...
var framesync_1 = tslib_1.__importStar(require("framesync"));
...
function h(layer, props) {
  var _ref;

  return _ref = {}, _defineProperty(_ref, types_1.$$TYPE, types_1.ElementType.Element), _defineProperty(_ref, "layer", layer), _defineProperty(_ref, "props", props), _ref;
}
...
/*#__PURE__*/
function () {
  function App(rootElement, options) {
    var _this = this;
    ...
    this.anchor = null;
    this.process = null;
    this.factory = OperationFactory_1.createOperationFactory();

    this.draw = function (_ref2) {
      var timestamp = _ref2.timestamp,
          delta = _ref2.delta;

      if (_this.anchor && _this.screen) {
        var next = _toConsumableArray(_this.rootElements);

        var limit = 10000;

        while (limit > 0) {
          limit--;
          next = types_1.flattenElements(next.map(function (elem) {
            if (types_1.isElement(elem)) {
              return elem.layer(_this.factory, elem.props, _objectSpread({
                timestamp: timestamp,
                delta: delta
              }, invariant_1.notNull(_this.screen)));
            }
          ...
          if (next.filter(function (elem) {
            return !types_1.isOperation(elem);
          }).length === 0) {
            break;
          }
        }
        ...
        next.forEach(function (elem) {
          if (types_1.isOperation(elem)) {
            _this.applyCanvasOperation(elem);
          } else {
            console.warn('whaaat ?');
          }
        });
    ...
    this.onResize = function () {
      ...
      if (_this.anchor) {
        _this.mount(_this.anchor.canvas);
      }
    };

    this.mount = function (elem) {
      var ctx = invariant_1.notNull(elem.getContext('2d'));
      _this.anchor = {
        canvas: elem,
        ctx: ctx
      };
      ...
      if (_this.screen) {
        elem.width = _this.screen.resolutionWidth;
        elem.height = _this.screen.resolutionHeight;
      } else {
    ...
    this.start = function () {
      if (_this.process === null) {
        _this.process = framesync_1.default.update(_this.draw, true);
      } else {
    ...
    this.stop = function () {
      if (_this.process) {
        framesync_1.cancelSync.update(_this.process);
      }
    };
  ...
  _createClass(App, [{
    ...
    key: "applyCanvasOperation",
    value: function applyCanvasOperation(ope) {
      if (this.anchor) {
        if (ope.property) {
          this.anchor.ctx[ope.type] = ope.args[0];
        } else {
          var _this$anchor$ctx;

          (_this$anchor$ctx = this.anchor.ctx)[ope.type].apply(_this$anchor$ctx, _toConsumableArray(ope.args));
        }
      }
    }
  }]);
...
exports.App = App;
},{"tslib":"../node_modules/tslib/tslib.es6.js","framesync":"../node_modules/framesync/dist/framesync.es.js","../../utils/invariant":"utils/invariant.ts","./types":"canvas/core/types.ts","./OperationFactory":"canvas/core/OperationFactory.ts"}],"canvas/layers/ClearLayer.ts":[function(require,module,exports) {
"use strict";
...
exports.ClearLayer = function (ctx, _ref, _ref2) {
...
},{}],"utils/range.ts":[function(require,module,exports) {
"use strict";
...
},{}],"canvas/layers/PolylineLayer.ts":[function(require,module,exports) {
"use strict";
...
exports.PolylineLayer = function (ctx, _ref) {
  var line = _ref.line;
  ...
  return [ctx.beginPath(), ctx.moveTo(line[0].x, line[0].y)].concat(_toConsumableArray(line.map(function (p) {
    return ctx.lineTo(p.x, p.y);
  })), [ctx.stroke()]);
};
},{}],"canvas/core/op.ts":[function(require,module,exports) {
"use strict";
...
function reverseOp(ope) {
  ...
  while (limit > 0) {
    ...
    if (_typeof(right) === 'symbol' && right === OP_VALUE) {
      break;
    }
    ...
    if (containValue(right.x)) {
      if (right.type === OpType.Add) {
        left = {
          type: OpType.Add,
          x: left,
          y: exports.Ops.multiply(right.y, -1)
        };
      ...
      if (right.type === OpType.Add) {
        left = {
          type: OpType.Add,
          x: left,
          y: exports.Ops.multiply(right.x, -1)
        };
      } else if (right.type === OpType.Multiply) {
        left = {
          type: OpType.Divide,
...
exports.reverseOp = reverseOp;

function createOp(creator) {
  return creator(OP_VALUE);
}

exports.createOp = createOp;

function applyOp(ope, value) {
  if (typeof ope === 'number') {
    return ope;
  }
...
},{}],"canvas/common.ts":[function(require,module,exports) {
"use strict";
...
var op_1 = require("./core/op");

var margin = 0.1;

var horizontal = function horizontal(width) {
  return op_1.createOp(function (val) {
    return op_1.Ops.add(op_1.Ops.multiply(width, margin), op_1.Ops.multiply(val, op_1.Ops.multiply(width, op_1.Ops.substract(1, op_1.Ops.multiply(margin, 2)))));
  });
};

var vertical = function vertical(height) {
  return op_1.createOp(function (val) {
    return op_1.Ops.substract(height, op_1.Ops.add(op_1.Ops.multiply(height, margin), op_1.Ops.multiply(val, op_1.Ops.multiply(height, op_1.Ops.substract(1, op_1.Ops.multiply(margin, 2))))));
  });
};

console.log(op_1.reverseOp(vertical(1000)));

function scaleUp(width, height, point) {
  return _objectSpread({}, point, {
    x: op_1.applyOp(horizontal(width), point.x),
    y: op_1.applyOp(vertical(height), point.y)
  });
}

exports.scaleUp = scaleUp;

function scaleDown(width, height, point) {
  return _objectSpread({}, point, {
    x: op_1.applyOp(op_1.reverseOp(horizontal(width)), point.x),
    y: op_1.applyOp(op_1.reverseOp(vertical(height)), point.y)
  });
}

exports.scaleDown = scaleDown;
},{"./core/op":"canvas/core/op.ts"}],"utils/bezier.ts":[function(require,module,exports) {
"use strict";
/**
...
var FLOAT32ARRAY_SUPPORTED = typeof Float32Array === 'function';
...
function bezier(mX1, mY1, mX2, mY2) {
  ...
  var sampleValues = FLOAT32ARRAY_SUPPORTED ? new Float32Array(kSplineTableSize) : new Array(kSplineTableSize);
...
},{}],"canvas/layers/AppLayer.ts":[function(require,module,exports) {
"use strict";
...
var ClearLayer_1 = require("./ClearLayer");

var range_1 = tslib_1.__importDefault(require("../../utils/range"));

var PolylineLayer_1 = require("./PolylineLayer");

var common_1 = require("../common");

var bezier_1 = require("../../utils/bezier");

var bez = bezier_1.bezier(0, 0, 0, -3);

exports.AppLayer = function (ctx, _ref, _ref2) {
  ...
  var splinePoints = range_1.default(100).map(function (i) {
    return i / 99;
  }).map(function (x) {
    return {
      x: x,
    ...
    return common_1.scaleUp(width, height, p);
  });
  return [core_1.h(ClearLayer_1.ClearLayer, {}), ctx.lineWidth(1), ctx.strokeStyle('rgba(0, 0, 0, 0.3)'), core_1.h(PolylineLayer_1.PolylineLayer, {
    line: [common_1.scaleUp(width, height, {
      x: 0,
      y: 0
    }), common_1.scaleUp(width, height, {
      x: 0,
      y: 1
    })]
  }), core_1.h(PolylineLayer_1.PolylineLayer, {
    line: [common_1.scaleUp(width, height, {
      x: 0,
      y: 0
    }), common_1.scaleUp(width, height, {
  ...
  }), ctx.lineWidth(2), ctx.strokeStyle('#2196F3'), core_1.h(PolylineLayer_1.PolylineLayer, {
    line: splinePoints
  })];
};
},{"tslib":"../node_modules/tslib/tslib.es6.js","../core":"canvas/core/index.ts","./ClearLayer":"canvas/layers/ClearLayer.ts","../../utils/range":"utils/range.ts","./PolylineLayer":"canvas/layers/PolylineLayer.ts","../common":"canvas/common.ts","../../utils/bezier":"utils/bezier.ts"}],"utils/math.ts":[function(require,module,exports) {
"use strict";
...
exports.PI = Math.PI;
},{}],"utils/geometry.ts":[function(require,module,exports) {
"use strict";
...
function findLineAngle(point1, point2) {
  ...
  var angle = Math.atan2(diffPoint.y, diffPoint.x);
  return angle;
}

exports.findLineAngle = findLineAngle;
/*
 *      /
 *     /    /
 *    /    /
...
function translateLineByDistance(distance, line) {
  var angle = findLineAngle(line[0], line[1]) + Math.PI / 2;
  return [translateDistanceAtAngle(angle, distance, line[0]), translateDistanceAtAngle(angle, distance, line[1])];
}

exports.translateLineByDistance = translateLineByDistance;
...
exports.translateDistanceAtAngle = translateDistanceAtAngle;

function translatePointFromLineAtAngle(point, ref, angle, distance) {
  var lineAngle = findLineAngle(point, ref);
  return translateDistanceAtAngle(lineAngle - angle, distance, point);
}

exports.translatePointFromLineAtAngle = translatePointFromLineAtAngle;
...
function lineIntersect(l1, l2) {
  var P1 = l1[0],
      ...
      P3 = l2[0],
      P4 = l2[1];
  var x = ((P1.x * P2.y - P2.x * P1.y) * (P3.x - P4.x) - (P1.x - P2.x) * (P3.x * P4.y - P3.y * P4.x)) / ((P1.x - P2.x) * (P3.y - P4.y) - (P1.y - P2.y) * (P3.x - P4.x));
  var y = ((P1.x * P2.y - P2.x * P1.y) * (P3.y - P4.y) - (P1.y - P2.y) * (P3.x * P4.y - P3.y * P4.x)) / ((P1.x - P2.x) * (P3.y - P4.y) - (P1.y - P2.y) * (P3.x - P4.x));
  return {
    x: x,
    y: y
  };
...
function polylineWeightToPolygone(poly) {
  if (poly.length < 2) {
  ...
  poly.forEach(function (p, i, arr) {
    if (i === 0) {
      var other = arr[1];
      start.push(translatePointFromLineAtAngle(p, other, -math_1.HALF_PI, p.weight));
      end.push(translatePointFromLineAtAngle(p, other, math_1.HALF_PI, p.weight));
      return;
    }

    if (i === arr.length - 1) {
      var _other = arr[i - 1];
      start.push(translatePointFromLineAtAngle(p, _other, math_1.HALF_PI, p.weight));
      end.push(translatePointFromLineAtAngle(p, _other, -math_1.HALF_PI, p.weight));
      return;
    }

    var prev = arr[i - 1];
    var next = arr[i + 1];
    var l1a = translatePointFromLineAtAngle(prev, p, -math_1.HALF_PI, prev.weight);
    var l1b = translatePointFromLineAtAngle(p, prev, math_1.HALF_PI, p.weight);
    var l2a = translatePointFromLineAtAngle(p, next, -math_1.HALF_PI, p.weight);
    var l2b = translatePointFromLineAtAngle(next, p, math_1.HALF_PI, next.weight);
    var p1 = lineIntersect([l1a, l1b], [l2a, l2b]);
    var l3a = translatePointFromLineAtAngle(prev, p, math_1.HALF_PI, prev.weight);
    var l3b = translatePointFromLineAtAngle(p, prev, -math_1.HALF_PI, p.weight);
    var l4a = translatePointFromLineAtAngle(p, next, math_1.HALF_PI, p.weight);
    var l4b = translatePointFromLineAtAngle(next, p, -math_1.HALF_PI, next.weight);
    var p2 = lineIntersect([l3a, l3b], [l4a, l4b]);
    start.push(p1);
    end.push(p2);
  });
  return [].concat(start, _toConsumableArray(end.reverse()));
}

exports.polylineWeightToPolygone = polylineWeightToPolygone;

function createArc(_ref) {
  var steps = _ref.steps,
      origin = _ref.origin,
      size = _ref.size,
      angle = _ref.angle;
  var prevPoint = origin;
  var nextAngle = angle(0, undefined);
  var nextSize = size(0, undefined);
  return range_1.default(steps).reduce(function (acc, i) {
...
},{"tslib":"../node_modules/tslib/tslib.es6.js","./math":"utils/math.ts","./range":"utils/range.ts"}],"canvas/index.ts":[function(require,module,exports) {
"use strict";
...
var AppLayer_1 = require("./layers/AppLayer");
...
function mountCanvas(store, el) {
  ...
  var canvasApp = new core_1.App(core_1.h(AppLayer_1.AppLayer, {
    store: store,
  ...
  var onDown = function onDown(event) {
    ...
    if (canvasState.hovered !== null) {
      // select
      var points = store.getState().map(function (point) {
        return common_1.scaleUp(window.innerWidth, window.innerHeight, point);
      });
      var selectedPoint = points[canvasState.hovered.index];
      canvasState.selected = _objectSpread({}, canvasState.hovered);
      canvasState.grabbed = {
        mouseOrigin: {
          x: x,
          y: y
        },
        itemOrigin: _objectSpread({}, selectedPoint),
        moved: false
      };
      return;
    }

    var cliked = common_1.scaleDown(window.innerWidth, window.innerHeight, {
      x: x,
      y: y
    });
    ...
    if (cliked.x >= 0 && cliked.x <= 1) {
      // create
      var _points = store.getState();

      var newPoint = _objectSpread({}, cliked, {
        c1: {
          x: 0.1,
          y: 0.1
        },
      ...
      canvasState.grabbed = {
        ...
        itemOrigin: common_1.scaleUp(window.innerWidth, window.innerHeight, newPoint),
        moved: false
      };
  ...
  var onUp = function onUp(_event) {
    if (canvasState.selected !== null && canvasState.pointJustCreated === false && canvasState.grabbed && canvasState.grabbed.moved === false) {
      store.mutate(function (state) {
  ...
  var onMove = function onMove(event) {
    ...
    if (canvasState.grabbed !== false) {
      ...
      if (canvasState.grabbed.moved === false && geometry_1.vectorLength(diff) > 3) {
        canvasState.grabbed.moved = true;
      }

      if (canvasState.selected && canvasState.selected.type === 'handle') {// const newK = canvasState.grabbed.itemOrigin.k - diff.y / 50;
        // store.mutate(state => {
        ...
        var newPos = common_1.scaleDown(window.innerWidth, window.innerHeight, {
          x: canvasState.grabbed.itemOrigin.x + diff.x,
          y: canvasState.grabbed.itemOrigin.y + diff.y
        });
        newPos.x = math_1.clamp01(newPos.x);
        store.mutate(function (state) {
          if (canvasState.selected !== null) {
    ...
    var reversedPoints = _toConsumableArray(points).reverse(); // handles
    ...
    reversedPoints.forEach(function (point, index) {
      if (found) {
        return;
      }

      var dist = geometry_1.distance(point, mouse);
      found = dist < 10;
  ...
  var onEnter = function onEnter(_event) {// console.log('onEnter');
  };
...
},{"./core":"canvas/core/index.ts","./layers/AppLayer":"canvas/layers/AppLayer.ts","../utils/geometry":"utils/geometry.ts","./common":"canvas/common.ts","../utils/math":"utils/math.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var uiEl = invariant_1.notNull(document.getElementById('app-ui'));
ui_1.mountUI(store, uiEl);
var canvasEl = invariant_1.notNull(document.getElementById('app-canvas'));
canvas_1.mountCanvas(store, canvasEl);
},{"./utils/invariant":"utils/invariant.ts","./ui":"ui/index.tsx","./store":"store/index.ts","normalize.css":"../node_modules/normalize.css/normalize.css","./index.css":"index.css","./canvas":"canvas/index.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
